...
<body>
	...
	<div class="container"
		...
		padding:20px">
		<p class="text-start fs-1 fw-bold">Register Form</p>
		<form action="requestProcBoot.jsp" method="post">
			...
			<div class="mb-1">
				<label for="exampleInputEmail1" class="form-label">tel</label> <input
			...
			<div class="mb-3">
				<label for="exampleInputEmail1" class="form-label">hobby</label> <select
					class="form-select" aria-label="Default select example"
					name="hobby">
					<option value="Swimming">Swimming</option>
					<option value="Walking">Walking</option>
					<option value="Breathing">Brething</option>
				</select>
			</div>
			...
			<div class="mb-3">
				...
				<div class="form-check">
					<input class="form-check-input" 
							type="checkbox" 
							value="Software Enginerer"
						id="flexCheckDefault"
						name="Jobs"> <label class="form-check-label"
						for="flexCheckDefault"> Software Enginerer </label>
				</div>
				<div class="form-check">
					<input class="form-check-input" type="checkbox" value="UI/UX
						Engineer"
						id="flexCheckChecked" name="Jobs" checked> <label
